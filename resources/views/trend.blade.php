                            ...
                            <div class="col-md-7">
                                <form id="formGenerate" method="POST" action="{{ route('trend.generate') }}"
                                    ...
                                    <div class="flex-grow-1">
                                        <label class="form-label fw-medium" style="font-size:.85rem">Nama Dataset
                                            </label>
                                ...
                                <tbody>
                                    @foreach ($trends as $i => $t)
                                        ...
                                        <tr onclick="toggleTrend({{ $i }})" style="cursor:pointer">
                                            ...
                                            <td>
                                                <div
                                                    style="font-size:.82rem;color:#475569;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;white-space:normal">
                                                    {{ $t->alasan_ai ?? '-' }}
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="expand-trend-{{ $i }}"
                                            style="display:none;background:#f8fafc">
                                            <td colspan="6"
                                                style="padding:12px 16px;font-size:.85rem;color:#334155;line-height:1.7;border-top:none">
                                                <span
                                                    style="font-size:.75rem;font-weight:600;color:#94a3b8;text-transform:uppercase;letter-spacing:.05em;display:block;margin-bottom:4px">Alasan
                                                    AI Lengkap</span>
                                                {{ $t->alasan_ai ?? '-' }}
                                            </td>
                                        </tr>
                ...
                <div class="section-card mb-4">
                    ...
                    <div class="p-4">
                                        ...
                                        <tr style="cursor:pointer" onclick="togglePreview({{ $i }})">
                                            ...
                                            <td class="text-center">
                                                <span class="fw-bold fs-6"
                                                    style="color:#1e2433">{{ number_format($t['skor_trend'], 2) }}</span>
                                            </td>
                                            <td>
                                                <div
                                                    style="font-size:.82rem;color:#475569;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;white-space:normal">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-4 pt-3"
                            ...
                            <p class="text-muted mb-0" style="font-size:.82rem">Pastikan skor masuk akal sebelum
                                disimpan ke Database.</p>
                            <div class="d-flex gap-2">
                                <form method="POST" action="{{ route('trend.clear') }}">
                                    @csrf
                                    <button type="submit" class="btn btn-outline-danger"
                                        style="border-radius:.6rem;font-size:.875rem">Reset</button>
                                </form>
                                @if (session('saved_trend'))
                                    <form method="POST" action="{{ route('trend.clear') }}">
                                        @csrf
                                        <button type="submit" class="btn btn-secondary"
                                            style="border-radius:.6rem;font-size:.875rem">Tutup Preview</button>
                                    </form>
                                @else
