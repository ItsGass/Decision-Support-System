...
<style>
    ...
    select.filter-control { padding-right: 2rem; }
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-block">
                    <ol class="breadcrumb mb-0 small">
                        ...
                        <li class="breadcrumb-item active text-primary">Penjualan</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="d-flex align-items-end flex-wrap gap-3">
                ...
                <div>
                    ...
                    <input type="date" name="start" value="{{ request('start') }}"
                           class="filter-control" style="width:165px">
                </div>
            ...
            <div class="col-12 col-md-4">
                <div class="stat-card blue">
                    <div class="d-flex align-items-start justify-content-between">
                        <div>
                            <p class="stat-label">Prediksi Bulan Ini</p>
                            <div class="stat-value text-primary">—</div>
                            <p class="stat-sub">Berdasarkan tren historis</p>
                        </div>
                        <div class="stat-icon" style="background:var(--accent-soft)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                 fill="var(--accent)" viewBox="0 0 16 16">
                                <path d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1zm1 12V2h-2v12zm-3 0V7H7v7zm-5 0v-3H2v3z"/>
                            </svg>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-start justify-content-between">
                        ...
                        <div class="stat-icon" style="background:var(--purple-soft)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                ...
                                <path d="M2.5 3a.5.5 0 0 0 0 1h11a.5.5 0 0 0 0-1zm2 3a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1zM4 9.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m.5 2.5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1z"/>
                            </svg>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="chart-card p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-4">
                        ...
                        <select id="filterMotor" name="motor_id" class="filter-control" style="width:auto;min-width:150px">
            ...
            <div class="col-12 col-lg-4">
                <div class="chart-card p-4 d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <span class="section-label bg-primary bg-opacity-10 text-primary">Log</span>
                        <h2 class="mb-0 fw-semibold" style="font-size:1rem;color:#1e2433">
                            Aktivitas Terbaru
                        </h2>
                    </div>

                    <ul class="list-unstyled mb-0 flex-fill">

                        <li class="activity-item d-flex align-items-start gap-3">
                            <span class="activity-dot mt-1" style="background:var(--success)"></span>
                            <div>
                                <p class="mb-0 fw-medium" style="font-size:.85rem;color:#1e2433">
                                    Sistem siap digunakan
                                </p>
                                <p class="mb-0 text-muted" style="font-size:.78rem">Status OK</p>
                            </div>
                            <span class="ms-auto badge bg-success bg-opacity-10 text-success fw-normal"
                                  style="font-size:.7rem;border-radius:2rem;height:fit-content;padding:.2rem .6rem">
                                OK
                            </span>
                        </li>

                        <li class="activity-item d-flex align-items-start gap-3">
                            <span class="activity-dot mt-1" style="background:var(--accent)"></span>
                            <div>
                                <p class="mb-0 fw-medium" style="font-size:.85rem;color:#1e2433">
                                    Data berhasil dimuat
                                </p>
                                <p class="mb-0 text-muted" style="font-size:.78rem">Data penjualan aktif</p>
                            </div>
                            <span class="ms-auto badge bg-primary bg-opacity-10 text-primary fw-normal"
                                  style="font-size:.7rem;border-radius:2rem;height:fit-content;padding:.2rem .6rem">
                                INFO
                            </span>
                        </li>
                    ...
                    {{-- Mini divider + refresh hint --}}
                    <div class="mt-3 pt-3 d-flex align-items-center gap-2"
                         style="border-top:1px solid var(--border-muted)">
                        <span style="width:8px;height:8px;border-radius:50%;background:#e9ecef;display:inline-block"></span>
                        <span class="text-muted" style="font-size:.76rem">
                            Data diperbarui otomatis saat filter berubah
                        </span>
                    </div>
